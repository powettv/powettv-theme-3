...
<?php if ($comments) : ?>
	<div id="commentslinks"><?php comments_rss_link(__('<abbr title="Really Simple Syndication">RSS</abbr> feed')); ?> 
<?php if ('open' == $post->ping_status) { ?>
| <a href="<?php trackback_url()?>">Trackback <acronym title="Uniform Resource Identifier">URI</acronym></a>
<?php } ?></div>
	<div id="comments"><?php comments_number('No Responses', '1 comment', '% comments' );?></div>
...
<?php 
$mygravatarurl = get_bloginfo('template_directory')."/images/gravatar.gif";
...
?>
			...
			<cite><?php comment_author_link() ?> said:</cite> 
